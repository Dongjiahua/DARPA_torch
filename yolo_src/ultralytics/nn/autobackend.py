...
class AutoBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, legend=None):
        """
        ...
        if self.pt or self.nn_module:  # PyTorch
            if legend is not None:
                y = self.model(im, augment=augment, visualize=visualize, legend=legend) if augment or visualize else self.model(im, legend=legend)
            else:
