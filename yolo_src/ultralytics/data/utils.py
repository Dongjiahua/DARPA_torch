...
def img2legend_paths(img_paths):
    """Define label paths as a function of image paths."""
    legend_path = ['_'.join(x.split('_')[0:-2])+'.png' for x in img_paths]
    sa, sb = f'{os.sep}images{os.sep}', f'{os.sep}legends{os.sep}'  # /images/, /legends/ substrings
    return [sb.join(x.rsplit(sa, 1)) for x in legend_path]
